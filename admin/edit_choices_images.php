...
link rel=stylesheet href=csslessons.css
div class=main-content
    h1Quiz  span class=quiz-topic-headerphp echo $topic; span  Edit  Question # php echo $question_no; h1
    div class=box
        div class=add-exam
            h2Edit question with image choicesspanh2
            form action= name=form1 method=post enctype=multipartform-data
                label for=exam-categoryQuestionlabel
                input type=text name=iquestion placeholder=Add a question value=php echo $q; 
                hr
                div class=box
                    img src=php echo $c1;  width=150 height=150 onerror=this.src='..imagesicons8-unavailable-100.png'
                    label Edit choice #1label
                    input type=file name=ic1 accept=image
                div
                div class=box
                    img src=php echo $c2;  width=150 height=150 onerror=this.src='..imagesicons8-unavailable-100.png'
                    label Edit choice #2label
                    input type=file name=ic2 accept=image
                div
                div class=box
                    img src=php echo $c3;  width=150 height=150 onerror=this.src='..imagesicons8-unavailable-100.png'
                    label Edit choice #3label
                    input type=file name=ic3 accept=image
                div
                div class=box
                    img src=php echo $c4;  width=150 height=150 onerror=this.src='..imagesicons8-unavailable-100.png'
                    label Edit choice #4label
                    input type=file name=ic4 accept=image
                div
                div class=box
                    img src=php echo $an;  width=150 height=150 onerror=this.src='..imagesicons8-unavailable-100.png'
                    label Edit answerlabel
                    input type=file name=ians accept=image
                div
                brbutton type=submit name=submit2Save Changesbutton
...
script type=textjavascript
    window.location.href = add_edit_quiz.phpid= + php echo $topic_id; ;
script
php 
}
